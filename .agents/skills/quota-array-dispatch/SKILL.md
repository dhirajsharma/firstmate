...
`AGENTS.md` section 4 owns the always-loaded intake boundary and section 13 the load trigger; this skill owns the malformed-config refusal, every-candidate accounting, and strongest-reasoning and tie safety rules below.
